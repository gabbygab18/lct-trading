...
// LCT: the registry's bouncy spring also drove opacity, so panels stayed
// see-through and wobbling for most of a second. Opaque in 0.15s now, with a
// small settled scale-in.
const dropdownVariants = {
  ...
  visible: {
    ...
    transition: {
      ...
      default: { type: "spring", stiffness: 520, damping: 38 },
    },
  },
  exit: {
    opacity: 0,
...
const itemVariants = {
  ...
  // LCT: capped stagger so a long list (14 brands) is fully in by ~0.2s
  // instead of the last item arriving 0.7s later.
  visible: (i) => ({
    opacity: 1,
    x: 0,
    transition: {
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent data-slot='dropdown-menu-sub-content' className='z-[200]' asChild {...props}>
      <motion.div
        variants={animate ? dropdownVariants : undefined}
        initial={animate ? 'hidden' : undefined}
        animate={animate ? 'visible' : undefined}
